...
const ProductCard = ({id, name, brand, image, europeu, price}) => {
    ...
    return (
        ...
        <p className="mx-4 text-sm text-green-400">{price}</p>
        <button className="bg-slate-950 rounded-md mx-4 my-1 text-slate-100 hover:bg-slate-900" onClick={() => {addToCart(id)}}>
